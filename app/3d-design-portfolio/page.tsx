...
import { ArrowLeft, Calendar, Clock, Wrench, Cog, Building, Target } from "lucide-react"
  ...
  const projects = [
    {
     ...
     {
          id: 3,
          title: "Longboard foot break",
          category: "3D design and modeling",
          duration: "1 week",
          date: "August 2024",
          description: "Designed and built a mechanical foot brake for a longboard that applies pressure to the rear wheels when stepped on.",
          process: [
            "Researched braking mechanisms and designed a compact system for longboards",
    "Created CAD models and technical drawings of the brake assembly",
    "Selected durable materials to withstand repeated mechanical stress",
    "Fabricated components using machining and hand tools",
    "Installed brake system onto deck and rear trucks",
    "Tested braking performance under different speeds and conditions",
